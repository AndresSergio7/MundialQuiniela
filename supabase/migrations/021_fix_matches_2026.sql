-- ============================================================
-- Migration 021: Reset completo de partidos FIFA World Cup 2026
-- TRUNCATE CASCADE limpia predicciones/standings dependientes,
-- luego inserta los 104 partidos correctos del PDF oficial.
-- ⚠️  Solo usar en entornos de prueba o antes del torneo.
-- ============================================================
...
-- TERCER LUGAR Y FINAL (Jul 18 – 19)
